 ...
 */
export declare const create: (context: PluginContext, requestedCompileOptions: CompileOptions, mangler: Mangle, memory: Ebbinghaus, inputOptions: InputOptions, outputOptions: OutputOptions) => Array<SourceTransform>;
/**
 ...
 */
export declare function transform(source: string, id: string, transforms: Array<SourceTransform>): Promise<SourceDescription>;
