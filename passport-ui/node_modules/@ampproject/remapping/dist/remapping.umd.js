(function (global, factory) {
    ...
    (global = global || self, global.remapping = factory());
    ...
    function decodeSourceMap(map) {
        ...
        return defaults({ mappings: mappings }, map);
    }
     ...
     */
    var OriginalSource = /** @class */ (function () {
         ...
         */
        OriginalSource.prototype.traceSegment = function (line, column, name) {
            return { column: column, line: line, name: name, source: this };
        };
     ...
     */
    var FastStringArray = /** @class */ (function () {
         ...
         */
        FastStringArray.prototype.put = function (key) {
            var _a = this, array = _a.array, indexes = _a.indexes;
     ...
     */
    var SourceMapTree = /** @class */ (function () {
         ...
         * files.
         */
        SourceMapTree.prototype.traceMappings = function () {
            var mappings = [];
            var names = new FastStringArray();
            var sources = new FastStringArray();
            var sourcesContent = [];
            var _a = this.map, rootMappings = _a.mappings, rootNames = _a.names;
            for (var i = 0; i < rootMappings.length; i++) {
                ...
                for (var j = 0; j < segments.length; j++) {
                    ...
                    var column = traced.column, line = traced.line, name = traced.name;
                    var _b = traced.source, content = _b.content, filename = _b.filename;
         ...
         */
        SourceMapTree.prototype.traceSegment = function (line, column, name) {
            var _a = this.map, mappings = _a.mappings, names = _a.names;
            ...
            var index = binarySearch(segments, column, segmentComparator$1);
    ...
    function buildSourceMapTree(input, loader, relativeRoot) {
        ...
        var sourceRoot = map.sourceRoot, sources = map.sources, sourcesContent = map.sourcesContent;
        var children = sources.map(function (sourceFile, i) {
            ...
            var uri = resolve$1(sourceFile || '', resolve$1(sourceRoot || '', stripFilename(relativeRoot)));
            // Use the provided loader callback to retrieve the file's sourcemap.
            // TODO: We should eventually support async loading of sourcemap files.
            var sourceMap = loader(uri);
    ...
    var SourceMap = /** @class */ (function () {
        function SourceMap(map, excludeContent) {
